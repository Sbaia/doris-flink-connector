...
/** Creates compressed Arrow IPC writers using the Arrow API shipped with Flink 2. */
public final class Flink2ZstdArrowStreamWriterProvider implements ZstdArrowStreamWriterProvider {

    public Flink2ZstdArrowStreamWriterProvider() {
        ZstdCompressionCodec.verifyNativeLibrary();
    }

    @Override
    public ArrowStreamWriter create(VectorSchemaRoot root, WritableByteChannel channel) {
